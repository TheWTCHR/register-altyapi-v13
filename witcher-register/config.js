module.exports = new (require("./types/Config"))({
  ...
  other: {
    kayıtYetkili: "",           // Kayıt etme yetkisi
    kayıtsızYetkili: "",        // Kayıtsıza atma yetkisi
    isimYetkili: "",            // İsim değiştirme yetkisi
    erkekRol: [""],             // Erkek Rolleri
    kızRol: [""],               // Kız Rolleri
    kayıtsızRol: [""],          // Kayıtsız Rolleri
    hgMesajKanal: ""            // Hos geldin mesajının atılacağı kanal
  },
  ...
  async onReady(client) {
    ...
    client.user.setActivity(`Witcher Register Altyapı`, { type: "COMPETING" });
